...
declare namespace PIXI {
    ...
    class SpriteMaskFilter extends Filter<any> {
    ...
    namespace filters {
        class FXAAFilter extends Filter<any> { }

        class BlurFilter extends Filter<any> {
        ...
        class BlurXFilter extends Filter<any> {
            constructor(strength?: number, quality?: number, resolution?: number, kernelSize?: number);
        ...
        class BlurYFilter extends Filter<any> {
            constructor(strength?: number, quality?: number, resolution?: number, kernelSize?: number);
        ...
        class ColorMatrixFilter extends Filter<any> {
            constructor();
        ...
        class DisplacementFilter extends Filter<any> {
            constructor(sprite: Sprite, scale?: number);

            scale: Point;
            map: Texture;
        }
        class VoidFilter extends Filter<any> {
            glShaderKey: number;
        }

        // pixi-filters.d.ts todo
        // https://github.com/pixijs/pixi-filters/
        class NoiseFilter extends Filter<any>{
            noise: number;
        }
    }
    ...
    namespace core {
         ...
         * @deprecated since version 3.0.6
         */
        type AbstractFilter = Filter<any>;
